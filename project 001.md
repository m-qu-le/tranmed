...
| G9 | Kiểm thử end-to-end và triển khai | Đang làm; migration/deploy/smoke một file đã đạt | Production smoke test đạt, có phương án rollback |
...
- [ ] **P001-G9-S07 — Smoke end-to-end.** Luồng API thật một PDF đã đạt; còn chọn nhiều chương trực tiếp trong UI, quan sát Local Feeder, preview/copy và download folder bằng trình duyệt.
