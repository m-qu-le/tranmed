...
Ghi chú vận hành dành cho Codex, đã đồng bộ sau khi đóng PROJECT 001–005 và PROJECT 007 (hàng đợi ưu tiên) ngày 22-07-2026. Không lưu secret, nội dung `.env`, PDF, prompt/response thô hoặc bản dịch của người dùng.
...
5. `../../archive/project-001/project-001.md` đến `../../archive/project-005/project-005.md` và `../../archive/project-007/project-007.md` — hồ sơ lịch sử đã đóng; P007 là hàng đợi ưu tiên.
...
- PROJECT 001–005 và P007 đều đã đóng; P003 là nguồn sự thật của pipeline chất lượng, P004 là nguồn sự thật của cảnh báo Markdown, P005 là nguồn sự thật của thống kê/worker pool, P007 là nguồn sự thật của hàng đợi ưu tiên, và mã nguồn hiện tại có ưu tiên cao nhất.
...
- P007 đã đóng: `priority=1` là hàng đợi ưu tiên tuyệt đối; upload priority vẫn bền vững khi circuit breaker ngủ nhưng chỉ được worker claim sau wake-up, trước mọi job thường đủ điều kiện.
