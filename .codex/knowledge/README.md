...
Ghi chú vận hành dành cho Codex, đã đồng bộ sau khi đóng PROJECT 001–004 ngày 17-07-2026 và dọn artifact thử nghiệm. Không lưu secret, nội dung `.env`, PDF, prompt/response thô hoặc bản dịch của người dùng.
...
5. `../../archive/project-001/project-001.md` đến `../../archive/project-004/project-004.md` — hồ sơ lịch sử đã đóng; P003 là pipeline chất lượng và P004 là lớp cảnh báo đầu ra hiện hành.
...
- PROJECT 001–004 đều đã đóng; P003 là nguồn sự thật của pipeline chất lượng, P004 là nguồn sự thật của cảnh báo Markdown, và mã nguồn hiện tại có ưu tiên cao nhất.
...
- P005 đang rollout: dashboard lấy thống kê toàn cục từ `/jobs/stats`; worker mặc định một lane và chỉ bật lane thứ hai trong budget source 10 MiB.
