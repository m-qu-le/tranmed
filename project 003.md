...
| G1 | Benchmark minimal/medium/high và pipeline nhiều lượt | Đang thực hiện (9/10) | Có báo cáo so sánh mù, chốt cấu hình bằng bằng chứng |
...
| G8 | Regression, tải, lỗi và benchmark 20 PDF | Đang thực hiện (8/10) | Test tự động đạt; benchmark thật có bằng chứng |
| G9 | Rollout production và theo dõi | Đang thực hiện (2/10) | Canary đạt, bật quality an toàn, rollback đã kiểm chứng |
