...
| Mã kế hoạch | P003 |
| Ngày lập | 15-07-2026 |
| Trạng thái tổng | Đang thực hiện G0–G2; đã có baseline, manifest, adapter và smoke benchmark B0–B4 |
...
| G1 | Benchmark minimal/medium/high và pipeline nhiều lượt | Đang thực hiện (9/11) | Có báo cáo so sánh mù, chốt cấu hình bằng bằng chứng |
...
| G8 | Regression, tải, lỗi và benchmark 20 PDF | Đang thực hiện (9/12; S11 đã có số liệu live nhưng chờ Render canary) | Test tự động đạt; benchmark thật có bằng chứng |
...
- [x] **P003-G1-S06 — Chạy B4.** Lưu riêng output từng stage và kết quả PASS/FAIL/repair.
...
- [x] Benchmark B0–B4 trên PDF thực đã hoàn thành và có báo cáo.
...
- Full-corpus live đã hoàn tất trước lượt tổng hợp hiện tại; không còn runner Node. Checkpoint có `completedAt`, 191/191 processed, 0 failed; stderr rỗng. Lượt hiện tại chỉ đọc checkpoint và chạy analyzer offline, không gọi Gemini mới.
