...
describe('App Cloud Uploader', () => {
  ...
  it('uses global job stats and loads extra files only for the opened folder', async () => {
    ...
    expect(within(dashboard).getByText('Chờ 473 · xử lý 1 · lỗi 0 · mất dấu vết 1')).toBeInTheDocument()
    expect(within(dashboard).queryByText(/đã xóa/i)).not.toBeInTheDocument()
